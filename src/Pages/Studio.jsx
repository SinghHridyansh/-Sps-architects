...
const ValueCard = ({ title, textContent }) => {
  return (
    <div className="py-3 px-10 w-96 h-32 ">
      <h3 className="text-project-yellow text-sm mb-3">{title}</h3>
      ...
      <div className="bg-black p-8 md:p-10">
        <div className="mt-24  flex justify-center items-center text-center">
          <div className="heading flex justify-center items-center flex-col gap-4 md:gap-8">
            ...
            <span className="text-center font-normal text-sm leading-6 tracking-widest md:w-3/6 md:text-base">
        ...
        <div className="flex justify-center flex-col text-center py-10 md:py-24">
          ...
          <div className="flex justify-center items-center gap-3 flex-col mt-8 md:mt-12 md:justify-evenly md:flex-row md:flex-wrap">
            {values.map((value) => (
              <ValueCard
                key={value.id}
      ...
      <div className="bg-project-gray text-black">
        <div className="p-10 md:py-24">
          <div className="heading flex justify-center items-center flex-col gap-4">
            ...
            <span className="text-center font-light text-sm leading-6 tracking-widest md:w-3/6 md:text-base">
              This is the space to introduce visitors to the business or brand.
              Briefly explain who's behind it, what it does and what makes it
              unique. Share its core values and what this site has to offer.{" "}
            </span>
